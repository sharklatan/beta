...
function load(category){
    ...
    /*$.post(server+""+category,{},function(obj){
        for (var x = 0;x <obj.AppList.length;x++){
            str+=addRow(obj.AppList[x].id,obj.AppList[x].name,obj.AppList[x].developer,obj.AppList[x].subtitle,obj.AppList[x].icon);
        }
...
function addRow(id,name,developer,subtitle){
    ...
    var str="                                    <li class=\"item-content\">\n" +
        ...
        "                                            <img class=\"lazy lazy-fadeIn\" src=\"https://topstore.vip/image/loading.gif\" data-src=\""+icon+"\" width=\"44\">\n" +
        "                                        </div>\n" +
