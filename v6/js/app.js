...
var discoverSwiper = new Swiper ('#discover-swiper', Object.assign({}, swiperOptions, {width: 320, autoplay: {delay: 3000}}));
...
$$(document).on('page:init', '.page[data-name="single"]', function (e, page) {
  ...
  var rpSwiper = new Swiper (swiperEl, Object.assign({}, swiperOptions, {width: 280}));
});
$$(document).on('page:init', '.page[data-name="single-2"]', function (e, page) {
  var swiperEl = page.$el.find('#single-swiper-2')[0];
  var rpSwiper2 = new Swiper (swiperEl, Object.assign({}, swiperOptions, {width: 280}));
});
